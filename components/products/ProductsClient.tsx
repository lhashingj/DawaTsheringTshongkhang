...
const inputCls =
  "w-full bg-slate-700 border border-slate-600 text-white rounded-lg px-3 py-2 text-sm focus:outline-none focus:border-orange-500 placeholder-slate-400 transition-colors";
          ...
          {hasFilters && (
            <div className="flex flex-wrap gap-2 mb-6">
              {[...activeCategories].map((cat) => (
                <span
                  key={cat}
                  className="inline-flex items-center gap-1 text-xs bg-orange-500/10 text-orange-400 border border-orange-500/30 rounded-full px-3 py-1 font-medium"
                >
                  {cat}
